---
title: "OpenSearch 2.13 で 日本語のオートコンプリートが実装しやすくなりました"
emoji: "🌟"
type: "tech"
...
OpenSearch 2.13 の[リリースノート](https://github.com/opensearch-project/documentation-website/blob/main/release-notes/opensearch-documentation-release-notes-2.13.0.md?plain=1#L30)を読んでいたところ、以下の記述を見つけました。
...
[OpenSearch ドキュメント](https://opensearch.org/docs/2.13/analyzers/token-filters/index/) によると、日本語をローマ字のタームに変換することでオートコンプリートの仕組みを実装しているようです。
